const THUMB_STYLES =
  ...
  'dark:[&::-webkit-slider-thumb]:border-zinc-600 dark:[&::-webkit-slider-thumb]:bg-zinc-300 ' +
  'dark:[&::-moz-range-thumb]:border-zinc-600 dark:[&::-moz-range-thumb]:bg-zinc-300'
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="relative h-5">
        <div className="absolute top-1/2 h-2 w-full -translate-y-1/2 rounded-full border border-paper-300 bg-paper-100 shadow-[inset_0_2px_3px_rgba(18,38,63,0.18)] dark:border-zinc-600 dark:bg-zinc-700" />
        <div
          className="absolute top-1/2 h-2 -translate-y-1/2 rounded-full bg-ink-800 shadow-[inset_0_1px_0_rgba(255,255,255,0.25)] dark:bg-ocre-500"
        ...
        <input
          ...
          value={lowValue}
          onChange={(event) =>
            onChange([Math.min(Number(event.target.value), highValue), highValue])
          }
      ...
      <div className="tnum flex items-center justify-between text-xs text-paper-600 dark:text-zinc-400">
