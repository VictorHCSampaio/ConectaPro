const THUMB_STYLES =
  ...
  'dark:[&::-webkit-slider-thumb]:border-slate-600 dark:[&::-webkit-slider-thumb]:bg-slate-300 ' +
  'dark:[&::-moz-range-thumb]:border-slate-600 dark:[&::-moz-range-thumb]:bg-slate-300'
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="relative h-5">
        <div className="absolute top-1/2 h-2 w-full -translate-y-1/2 rounded-full border border-paper-300 bg-paper-100 shadow-[inset_0_2px_3px_rgba(18,38,63,0.18)] dark:border-slate-600 dark:bg-slate-700" />
        <div
      ...
      <div className="tnum flex items-center justify-between text-xs text-paper-600 dark:text-slate-400">
