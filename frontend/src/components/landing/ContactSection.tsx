        ...
        <Reveal>
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              <span className="label-mono text-ink-600">Para Professores</span>
              ...
              <p className="max-w-md leading-relaxed text-ink-700">
            ...
            <ul className="flex flex-col gap-4">
              {CONTACT_INFOS.map(({ icon: Icon, label }) => (
                <li key={label} className="flex items-center gap-3">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-ocre-100 text-ocre-500">
                    <Icon size={17} />
                  </span>
          ...
          <div className="rounded-2xl border border-paper-200 bg-white p-8 shadow-sm">
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div className="flex flex-col gap-1.5">
                <label
                  htmlFor="name"
                  className="text-xs font-medium uppercase tracking-wide text-ink-800"
                >
                  Nome Completo
                </label>
                <input
                  ...
                  required
                  className="w-full rounded-lg border border-paper-300 bg-white px-4 py-2.5 text-sm text-ink-900 placeholder:text-paper-400 outline-none transition focus:border-ocre-400 focus:ring-1 focus:ring-ocre-400/40"
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  required
                  className="w-full resize-none rounded-lg border border-paper-300 bg-white px-4 py-2.5 text-sm text-ink-900 placeholder:text-paper-400 outline-none transition focus:border-ocre-400 focus:ring-1 focus:ring-ocre-400/40"
                />
              </div>
