...
export function FormFeedback({ message, variant = 'success' }: FormFeedbackProps) {
  ...
  return (
    <div className="flex items-start gap-2.5 rounded-md border border-sage-600/20 bg-sage-50 dark:bg-emerald-900/30 px-4 py-3 text-sm text-sage-600 dark:text-emerald-400 shadow-[inset_0_1px_0_#fff]">
